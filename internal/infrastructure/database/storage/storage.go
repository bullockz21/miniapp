...
type Storage interface {
	CreateNewCustomer(ctx context.Context, newCustomer dto.DBCreateCustomerDTO) (id int, err error)
	LoadCustomer(ctx context.Context, id int) (dto.DBLoadCustomerDTO, error)
	...
	// UpdateOrder(ctx context.Context, order dto.OrderDTO, inId int) (id int, err error)
	...
	// LoadOrders(ctx context.Context) (orders []dto.OrderDTO, err error)
